...
| `@emulon/telegram` | Supported Telegram Bot API workflows |
...
9. Start the polling-only Telegram Bot API slice in [ADR 0037](decisions/0037-telegram-bot-api-polling-slice.md) with bots, token authentication and `getMe`.
